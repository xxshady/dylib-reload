...
pub fn on_alloc(module: ModuleId, ptr: *mut u8, layout: StableLayout) {
    ...
    #[unsafe(no_mangle)]
    static mut _____Internal___Imports____on_alloc: extern "C" fn(
        module: ModuleId,
        ptr: *mut u8,
        layout: StableLayout,
    ) = placeholder;
    ...
    unsafe { _____Internal___Imports____on_alloc(module, ptr, layout) }
}
...
pub fn unrecoverable(message: Str) -> ! {
    #[allow(non_upper_case_globals)]
    #[unsafe(no_mangle)]
    static mut _____Internal___Imports____unrecoverable: extern "C" fn(
        message: Str,
    ) -> ! = placeholder;
